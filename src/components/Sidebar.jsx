...
const Sidebar = () => {
  ...
  const activeLink = 'flex items-center m-2 gap-5 text-white bg-cyanl-100 pl-4 pt-3 pb-2.5 rounded-lg';
  const normalLink = 'flex items-center m-2 gap-5 text-gray-700 pl-4 pt-3 pb-2.5 hover:bg-light-gray rounded-lg';
